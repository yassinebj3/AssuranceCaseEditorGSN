	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CorePackage.CONTEXT: {
				...
				if (result == null) result = caseCoreElement(context);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.JUSTIFICATION: {
				Justification justification = (Justification)theEObject;
				T result = caseJustification(justification);
				if (result == null) result = caseCoreElement(justification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.ASSUMPTION: {
				...
				if (result == null) result = caseCoreElement(assumption);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
