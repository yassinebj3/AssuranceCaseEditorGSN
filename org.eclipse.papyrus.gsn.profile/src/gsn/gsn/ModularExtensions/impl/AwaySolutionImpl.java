 ...
 * </p>
 * <ul>
 *   <li>{@link gsn.gsn.ModularExtensions.impl.AwaySolutionImpl#getModuleIdentifierReference <em>Module Identifier Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AwaySolutionImpl extends CoreElementImpl implements AwaySolution {
	/**
	...
	protected EClass eStaticClass() {
		return ModularExtensionsPackage.Literals.AWAY_SOLUTION;
	}
	...
	public void setModuleIdentifierReference(String newModuleIdentifierReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModularExtensionsPackage.AWAY_SOLUTION__MODULE_IDENTIFIER_REFERENCE, oldModuleIdentifierReference, moduleIdentifierReference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModularExtensionsPackage.AWAY_SOLUTION__MODULE_IDENTIFIER_REFERENCE:
