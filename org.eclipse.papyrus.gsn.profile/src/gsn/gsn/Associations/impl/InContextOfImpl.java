 ...
 * </p>
 * <ul>
 *   <li>{@link gsn.gsn.Associations.impl.InContextOfImpl#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InContextOfImpl extends MinimalEObjectImpl.Container implements InContextOf {
	...
	protected IObservableList<?> observableAssociation;
	...
	protected EClass eStaticClass() {
		return AssociationsPackage.Literals.IN_CONTEXT_OF;
	}
		...
		if (base_Association != null && base_Association.eIsProxy()) {
			...
			if (base_Association != oldBase_Association) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AssociationsPackage.IN_CONTEXT_OF__BASE_ASSOCIATION, oldBase_Association, base_Association));
			}
		}
	...
	public void setBase_Association(Association newBase_Association) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssociationsPackage.IN_CONTEXT_OF__BASE_ASSOCIATION, oldBase_Association, base_Association));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssociationsPackage.IN_CONTEXT_OF__BASE_ASSOCIATION:
