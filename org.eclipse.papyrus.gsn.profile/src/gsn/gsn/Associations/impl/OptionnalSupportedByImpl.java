...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Optionnal Supported By</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gsn.gsn.Associations.impl.OptionnalSupportedByImpl#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OptionnalSupportedByImpl extends MinimalEObjectImpl.Container implements OptionnalSupportedBy {
	/**
	 ...
	 * @generated
	 */
	protected OptionnalSupportedByImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AssociationsPackage.Literals.OPTIONNAL_SUPPORTED_BY;
	}
		...
		if (base_Association != null && base_Association.eIsProxy()) {
			...
			if (base_Association != oldBase_Association) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AssociationsPackage.OPTIONNAL_SUPPORTED_BY__BASE_ASSOCIATION, oldBase_Association, base_Association));
			}
		}
	...
	public void setBase_Association(Association newBase_Association) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssociationsPackage.OPTIONNAL_SUPPORTED_BY__BASE_ASSOCIATION, oldBase_Association, base_Association));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssociationsPackage.OPTIONNAL_SUPPORTED_BY__BASE_ASSOCIATION:
