...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Nary In Context Of</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gsn.gsn.Associations.impl.NaryInContextOfImpl#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NaryInContextOfImpl extends MinimalEObjectImpl.Container implements NaryInContextOf {
	/**
	...
	protected EClass eStaticClass() {
		return AssociationsPackage.Literals.NARY_IN_CONTEXT_OF;
	}
		...
		if (base_Association != null && base_Association.eIsProxy()) {
			...
			if (base_Association != oldBase_Association) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AssociationsPackage.NARY_IN_CONTEXT_OF__BASE_ASSOCIATION, oldBase_Association, base_Association));
			}
		}
	...
	public void setBase_Association(Association newBase_Association) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssociationsPackage.NARY_IN_CONTEXT_OF__BASE_ASSOCIATION, oldBase_Association, base_Association));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssociationsPackage.NARY_IN_CONTEXT_OF__BASE_ASSOCIATION:
