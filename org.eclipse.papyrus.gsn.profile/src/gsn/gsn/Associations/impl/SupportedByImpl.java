 ...
 * </p>
 * <ul>
 *   <li>{@link gsn.gsn.Associations.impl.SupportedByImpl#getBase_Association <em>Base Association</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SupportedByImpl extends MinimalEObjectImpl.Container implements SupportedBy {
	...
	protected EClass eStaticClass() {
		return AssociationsPackage.Literals.SUPPORTED_BY;
	}
		...
		if (base_Association != null && base_Association.eIsProxy()) {
			...
			if (base_Association != oldBase_Association) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AssociationsPackage.SUPPORTED_BY__BASE_ASSOCIATION, oldBase_Association, base_Association));
			}
		}
	...
	public void setBase_Association(Association newBase_Association) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssociationsPackage.SUPPORTED_BY__BASE_ASSOCIATION, oldBase_Association, base_Association));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssociationsPackage.SUPPORTED_BY__BASE_ASSOCIATION:
