 ...
 *****************************************************************************/
package org.eclipse.papyrus.gsn.architecture;

import org.eclipse.emf.common.util.URI;
import org.eclipse.emf.ecore.EObject;
import org.eclipse.papyrus.gsn.profile.GsnResources;
...
public class TrainingLibraryModelCreationCommand extends ModelCreationCommandBase {
	...
	protected void initializeModel(EObject owner) {
		...
		Profile trainingLibraryProfile = (Profile) PackageUtil.loadPackage(URI.createURI(GsnResources.PROFILE_PATH), owner.eResource().getResourceSet());
